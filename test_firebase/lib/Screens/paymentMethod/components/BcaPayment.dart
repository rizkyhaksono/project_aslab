...
class BcaPayment extends StatefulWidget {
  const BcaPayment({Key? key}) : super(key: key);

  @override
  State<BcaPayment> createState() => _BcaPaymentState();
}

var rekeningTujuan = "1234 5678 98";

class _BcaPaymentState extends State<BcaPayment> {
  @override
