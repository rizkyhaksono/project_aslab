...
class BniPayment extends StatefulWidget {
  const BniPayment({Key? key}) : super(key: key);

  @override
  State<BniPayment> createState() => _BniPaymentState();
}

var rekeningTujuan = "6571 9821 32";

class _BniPaymentState extends State<BniPayment> {
  @override
