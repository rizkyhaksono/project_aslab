...
class BriPayment extends StatefulWidget {
  const BriPayment({Key? key}) : super(key: key);

  @override
  State<BriPayment> createState() => _BriPaymentState();
}

var rekeningTujuan = "9801 6781 87";

class _BriPaymentState extends State<BriPayment> {
  @override
